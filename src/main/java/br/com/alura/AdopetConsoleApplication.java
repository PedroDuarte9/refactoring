...
public class AdopetConsoleApplication {
    ...
    private static void listarAbrigos() throws Exception{
    ...
    private static void listarPetsDoAbrigo() throws Exception{
    ...
    private static void importarPets() throws Exception{
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
